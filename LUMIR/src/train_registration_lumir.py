...
def run(opt):
    ...
    model, optimizer, init_epoch = getters.getTrainModelWithCheckpoints(opt, model_type='best')
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--model", type = str, default = 'encoderOnlyComplex')
    parser.add_argument("-bs", "--batch_size", type = int, default = 1)
    parser.add_argument("-d", "--dataset", type = str, default = 'lumir_noseg')
    parser.add_argument("--gpu_id", type = str, default = '5')
    parser.add_argument("-dp", "--datasets_path", type = str, default = "./LUMIR_L2R24_TrainVal")
    parser.add_argument("--json_path", type = str, default = "./LUMIR_L2R24_TrainVal/LUMIR_dataset_noseg.json")
    parser.add_argument("--epochs", type = int, default = 201)
    parser.add_argument("--reg_w", type = float, default = 6.)
