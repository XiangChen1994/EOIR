...
def run(opt):
    ...
    with torch.no_grad():
        for data in test_loader:
            ...
            pos_flow1 = model(x,y,registration=True)
            pos_flow2 = model(y,x,registration=True)
...
'''
python test_registration_ACDC.py -d acdcreg -m EOIR_ACDC --is_save 0 start_channel=32 --gpu_id 5 
'''